...
public class InscricaoResource implements Messages {
    ...
    @Fallback(fallbackMethod = "getAllInscricoesFallback")
    ...
    public Response getAllInscricoesFallback(Long userId) {
        return Response.status(Response.Status.TOO_MANY_REQUESTS)
                .entity(mensagemToJSON(Messages.MSG_SERVICO_INDISPONIVEL_RATE_LIMITADA))
                .build();
    }
    public Response getAllInscricoesFallback(Long userId, Long eventoId) {
        return Response.status(Response.Status.TOO_MANY_REQUESTS)
                .entity(mensagemToJSON(Messages.MSG_SERVICO_INDISPONIVEL_RATE_LIMITADA))
                .build();
    }
